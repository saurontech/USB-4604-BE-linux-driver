...
int xr_usb_serial_set_reg(struct xr_usb_serial *xr_usb_serial,int regnum, int value)
{
	...
	else if(xr_usb_serial->DeviceProduct == 0x1411)
	{
	    result = usb_control_msg(xr_usb_serial->dev,                     /* usb device */
		   ...
		   (xr_usb_serial->DeviceProduct == 0xB604)||
		   (xr_usb_serial->DeviceProduct == 0xB704))
...
int adv_usb_serial_set_soft_flow_mode(struct xr_usb_serial *xr_usb_serial, 
		struct tty_struct *tty)
{
	...
	xr_usb_serial_get_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, temp);
	xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, (*temp) & ~0x07);
	kfree(temp);
	return 0;
}
...

{
        short *data;
		int result, retval;
	data = kmalloc(sizeof(short), GFP_KERNEL);
		...
		if (result)
			retval = (((*data) & 0x8) ? 0: TIOCM_DTR) | (((*data) & 0x20) ? 0:TIOCM_RTS ) | (((*data) & 0x4) ? 0:TIOCM_DSR) | (((*data) & 0x1) ? 0 : TIOCM_RI) | (((*data) & 0x2) ? 0:TIOCM_CD) | (((*data) & 0x10) ? 0 : TIOCM_CTS); 
		else
			retval = -EFAULT;
	kfree(data);
	return retval;
...
void adv_usb_serial_set_mode(struct xr_usb_serial *xr_usb_serial)
{
	short *temp;

	if((xr_usb_serial->DeviceProduct == 0xB604)||
			(xr_usb_serial->DeviceProduct == 0xB704))
	{
		temp = kmalloc(sizeof(short), GFP_KERNEL);
		if(xr_usb_serial->mode == 232){
			xr_usb_serial_get_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, temp);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, (*temp) & ~0x1C0);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_dir_addr, 0x1E8);
			xr_usb_serial_get_reg(xr_usb_serial, 0x13, temp);
			xr_usb_serial_set_reg(xr_usb_serial, 0x13, (*temp) | 0x28);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_set_addr, 0x140);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_clr_addr, 0x80);
		} else if(xr_usb_serial->mode == 422) {
			xr_usb_serial_get_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, temp);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, (*temp) & ~0x1C0);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_dir_addr, 0x1C0);
			xr_usb_serial_get_reg(xr_usb_serial, 0x13, temp);
			xr_usb_serial_set_reg(xr_usb_serial, 0x13, (*temp) & ~0x1C0);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_set_addr, 0x80);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_clr_addr, 0x140);
		} else if(xr_usb_serial->mode == 485) {
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, 0x38);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_dir_addr, 0x140);
			xr_usb_serial_set_reg(xr_usb_serial, 0x13, ~0x1C0);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_set_addr, 0x0);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_clr_addr, 0x140);
		} else {
			xr_usb_serial_get_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_mode_addr, temp);
			...
			xr_usb_serial_get_reg(xr_usb_serial, 0x13, temp);
			xr_usb_serial_set_reg(xr_usb_serial, 0x13, (*temp) & ~0x1C0);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_set_addr, 0x100);
			xr_usb_serial_set_reg(xr_usb_serial, xr_usb_serial->reg_map.uart_gpio_clr_addr, 0x0);
		}
		kfree(temp);
	}
}
